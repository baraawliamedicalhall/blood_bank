        ...
        <div class="col-md-6 offset-md-3 form-container">
            ...
            <form class="form-group" action="" method="post">
                ...
                <div class="form-inline">
                    ...
                    <select class="form-control demo-default" id="date" name="date" style="margin-bottom:10px;"
                        required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="contact_no" value="" placeholder="03********" class="form-control" required
